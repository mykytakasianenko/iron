...
const timeSlots = [
	...
	},
	{
		...
		image:
			"https://images.unsplash.com/photo-1533681904393-9ab6eee7e408?w=400&q=80",
	},
	{
		id: "afternoon",
		title: "Afternoon",
	...
	},
	{
		...
		image:
			"https://images.unsplash.com/photo-1556817411-31ae72fa3ea0?w=400&q=80",
	},
	{
		id: "flexible",
		title: "Flexible",
				...
				<View className="pb-8 gap-4">
					{timeSlots.map((slot) => (
						<Pressable
							...
							className={`relative overflow-hidden rounded-2xl h-36 ${
								selected === slot.id ? "opacity-100" : "opacity-90"
							}`}
						>
							<Image
